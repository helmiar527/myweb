...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-warning shadow-sm">
    <div class="container">
      <a class="navbar-brand" href="index.php">HelmiAR527</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          <li class="nav-item">
            <a class="nav-link active btn btn-" aria-current="page" href="index.php">Beranda</a>
          </li>
          <li class="nav-item">
  ...
  <section class="jumbotron">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
      <path fill="#ffffff" fill-opacity="1" d="M0,256L34.3,245.3C68.6,235,137,213,206,213.3C274.3,213,343,235,411,250.7C480,267,549,277,617,250.7C685.7,224,754,160,823,138.7C891.4,117,960,139,1029,144C1097.1,149,1166,139,1234,160C1302.9,181,1371,235,1406,261.3L1440,288L1440,320L1405.7,320C1371.4,320,1303,320,1234,320C1165.7,320,1097,320,1029,320C960,320,891,320,823,320C754.3,320,686,320,617,320C548.6,320,480,320,411,320C342.9,320,274,320,206,320C137.1,320,69,320,34,320L0,320Z"></path>
    </svg>
  </section>
  <!-- Akhir Jumbotron -->
  <!-- Bootstrap JS -->
